...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/11/09 12:48:36 by rofourni          #+#    #+#              #
#    Updated: 2016/11/21 17:17:32 by rofourni         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_memset.c ft_bzero.c ft_memcpy.c ft_memchr.c  \
	...
	ft_toupper.c ft_tolower.c ft_memccpy.c ft_memmove.c ft_memalloc.c \
	ft_memdel.c ft_strnew.c ft_strdel.c ft_strclr.c ft_striter.c \
	ft_striteri.c ft_strmap.c ft_strmapi.c ft_strequ.c ft_strnequ.c \
	ft_strsub.c ft_strjoin.c ft_strtrim.c ft_strsplit.c ft_putchar.c \
	ft_putstr.c ft_putendl.c ft_putnbr.c ft_putchar_fd.c \
	ft_putnbr_fd.c ft_putendl_fd.c ft_putstr_fd.c ft_itoa.c \
	ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c ft_lstiter.c \
	ft_lstmap.c ft_strlenint.c ft_count_words.c ft_countletters.c \
	ft_swap.c ft_sqrt.c

OBJ = ft_memset.o ft_bzero.o ft_memcpy.o ft_memchr.o \
	...
	ft_toupper.o ft_tolower.o ft_memccpy.o ft_memmove.o ft_memalloc.o \
	...
	ft_strsub.o ft_strjoin.o ft_strtrim.o ft_strsplit.o ft_putchar.o \
	ft_putstr.o ft_putendl.o ft_putnbr.o ft_putchar_fd.o \
	ft_putnbr_fd.o ft_putendl_fd.o ft_putstr_fd.o ft_itoa.o \
	ft_lstnew.o ft_lstdelone.o ft_lstdel.o ft_lstadd.o ft_lstiter.o \
	ft_lstmap.o ft_strlenint.o ft_count_words.o ft_countletters.o \
	ft_swap.o ft_sqrt.o

all: $(NAME)

$(NAME):
		gcc $(OPTIONS) $(FLAGS) $(SRC)
		ar rc $(NAME) $(OBJ)
		ranlib $(NAME)
